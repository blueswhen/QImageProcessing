#############################################################################
# Makefile for building: imageprocessing
# Generated by qmake (2.01a) (Qt 4.8.5) on: ?? 5? 11 21:25:51 2014
# Project:  im.pro
# Template: app
...
INCPATH       = -I/usr/local/Trolltech/Qt-4.8.5/mkspecs/linux-g++ -I. -I/usr/local/Trolltech/Qt-4.8.5/include/QtCore -I/usr/local/Trolltech/Qt-4.8.5/include/QtGui -I/usr/local/Trolltech/Qt-4.8.5/include -I/usr/local/include -I/usr/local/include/opencv -I/usr/local/include/opencv2 -I. -I.
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/usr/local/Trolltech/Qt-4.8.5/lib
LIBS          = $(SUBLIBS)  -L/usr/local/Trolltech/Qt-4.8.5/lib /usr/local/lib/libopencv_highgui.so /usr/local/lib/libopencv_core.so /usr/local/lib/libopencv_imgproc.so -lQtGui -L/usr/local/Trolltech/Qt-4.8.5/lib -L/usr/X11R6/lib -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = src/main.cpp \
		src/mainwindow.cpp \
		src/utils.cpp \
		src/inpainting.cpp moc_mainwindow.cpp
OBJECTS       = main.o \
		mainwindow.o \
		utils.o \
		inpainting.o \
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/imageprocessing1.0.0 || $(MKDIR) .tmp/imageprocessing1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/imageprocessing1.0.0/ && $(COPY_FILE) --parents include/mainwindow.h include/inpainting.h .tmp/imageprocessing1.0.0/ && $(COPY_FILE) --parents src/main.cpp src/mainwindow.cpp src/utils.cpp src/inpainting.cpp .tmp/imageprocessing1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/imageprocessing1.0.0/ && (cd `dirname .tmp/imageprocessing1.0.0` && $(TAR) imageprocessing1.0.0.tar imageprocessing1.0.0 && $(COMPRESS) imageprocessing1.0.0.tar) && $(MOVE) `dirname .tmp/imageprocessing1.0.0`/imageprocessing1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/imageprocessing1.0.0
...
inpainting.o: src/inpainting.cpp include/inpainting.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o inpainting.o src/inpainting.cpp
